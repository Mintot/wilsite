...
EMAIL_HOST = config('EMAIL_HOST', default='smtp.mail.yahoo.com')
EMAIL_HOST_USER = config('EMAIL_HOST_NAME', default='wildcatlabs@yahoo.com')
EMAIL_HOST_PASSWORD = config('EMAIL_PASSWORD', default='wildcatlabs101!')
